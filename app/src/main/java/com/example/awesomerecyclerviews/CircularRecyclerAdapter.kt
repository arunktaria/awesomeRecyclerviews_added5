...
class CircularRecyclerAdapter(val context: Context, val list:ArrayList<DataModel>) : RecyclerView.Adapter<CircularRecyclerAdapter.ViewHolderclss>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderclss {
        val view= LayoutInflater.from(context).inflate(R.layout.miniitemlist,parent,false)
    ...
    {
        val titletextview=view.findViewById<ImageView>(R.id.miniimageview)
